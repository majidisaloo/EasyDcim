    ...
    private function renderServersTab(): void
    {
        ...
        if (!$apiAvailable) {
            ...
            echo '<script>(function(){'
                ...
                . 'if(noProgressTicks>=3){continueByForm();return;}'
                . 'if(j && j.state && ((j.state.running)||((j.state.total||0)>(j.state.done||0))) && running){timer=setTimeout(tick,700);}else{running=false;}})'
