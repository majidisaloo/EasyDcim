    ...
    private function renderServersTab(): void
    {
        ...
        if (!$apiAvailable) {
            ...
            echo '<script>(function(){'
                ...
                . 'function postAjax(url,fields){var fd=new FormData();Object.keys(fields||{}).forEach(function(k){fd.append(k,fields[k]);});return fetch(url,{method:"POST",body:fd,credentials:"same-origin",headers:{"X-Requested-With":"XMLHttpRequest","Accept":"application/json"}}).then(function(r){return r.text();});}'
                . 'function call(op){'
